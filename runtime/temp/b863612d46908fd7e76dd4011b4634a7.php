<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/app.duzhiqiang.com/application/app/view/index/qudao.html";i:1534681736;}*/ ?>
<!doctype html>
...
<body>
  <div class="sp-content">
  	...
  	<div class="rule">
  		...
  		<ul>
  			<li>VIP影视是一款免费看爱奇艺、优酷、腾讯、乐视、芒果TV、搜狐、PPTV等VIP视频的APP。</li>
  			<li>需下载VIP影视APP，用手机号注册登录后，在【充值】页面使用体验时长券。</li>
...
<script type="text/javascript">
  function getZce() {
    ...
    $.ajax({
      type: "GET",
      url: "http://app.duzhiqiang.com/login/login/zce.html",
  ...
  function tourl(){
    window.location.href='http://app.duzhiqiang.com/app/index/m.html';
  }
</script>
</html>
